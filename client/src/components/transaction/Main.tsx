              ...
              <div>
                ...
                <div className={'flex flex-col gap-[10px] mt-[15px]'}>
                  ...
                  <div>
                    ...
                    <p className={'font-bold'}>{activePayMethod?.region?.name}</p>
                  </div>
                  ...
                  <div>
                    <p className={'text-sm text-gray font-medium'}>Payment Description</p>
                    <p>
          ...
          case 1:
            return (
              <div className={'h-[480px] flex items-center justify-center'}>
                <div>
                  <h1 className={'text-lg font-bold'}>Waiting for other user make his transfer</h1>
                </div>
              </div>
            )
          case 2:
